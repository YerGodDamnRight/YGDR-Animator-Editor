...
namespace YGDR.Editor.Animation
{
    internal static class L10n
    {
        ...
        static Dictionary<string, string> BuildEnglishDict() => new()
        {
            ...
            ["controller.network.preserve_props"]     = "Preserve Transition Props",
            ["controller.network.sync_param_name"]    = "Sync Param Name",
            ["controller.network.states_prefix"]      = "Network States Prefix",
            ["controller.network.remove_behaviours"]  = "Remove Network Behaviours",
            ["controller.network.params"]             = "Params",
            ["controller.network.audio"]              = "Audio",
            ["controller.network.tracking"]           = "Tracking",
            ["controller.network.pack_subsm"]         = "Pack into SubSM",
            ...
            ["context_menu.frame_move_nodes"]     = "Move Nodes with Frame",
            ...
            ["params_menu.set_not_synced"] = "Set Not Synced",
            ["params_menu.set_synced"]     = "Set Synced",
            ["params_menu.add_to_vrc"]     = "Add to VRC Parameters",
            ["params_menu.add_all_to_vrc"] = "Add All to VRC Parameters",
